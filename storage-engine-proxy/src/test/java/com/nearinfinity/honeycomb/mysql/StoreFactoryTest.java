...
public class StoreFactoryTest {
    ...
    private static Map<String, String> properties = new HashMap<String, String>() {{
        put(Constants.DEFAULT_BACKEND_PROP, BackendType.HBASE.getName());
        put("option2", "value2");
    }};
    ...
    @Test
    public void testDefaultBackendIsUsed() {
    ...
    private StoreFactory createFactory() {
        HoneycombConfiguration configuration = new HoneycombConfiguration(properties);
        Map<BackendType, Provider<Store>> map = Maps.newHashMap();
        map.put(BackendType.HBASE, storeProvider);
        when(storeProvider.get()).thenReturn(store);
        return new StoreFactory(map, configuration);
    }
}
