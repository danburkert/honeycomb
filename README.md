...
To configure Honeycomb to use a remote HBase, replace `{ZOOKEEPER QUORUM}` in `mysql-5.5.31-honeycomb-0.1-SNAPSHOT/honeycomb.xml` with your Zookeeper quorum address
