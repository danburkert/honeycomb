...
public class ITUtils {
    ...
    public static TableSchema getTableSchema() {
        ...
        indices.put(TestConstants.INDEX1, new IndexSchema(Lists.newArrayList(TestConstants.COLUMN1), false));

        // Add non-unique compound index on (c1, c2)
        indices.put(TestConstants.INDEX2, new IndexSchema(Lists.newArrayList(TestConstants.COLUMN1, TestConstants.COLUMN2), false));
