...
mysql.server stop 
mysql.server start --character-set-server=utf8 --collation-server=utf8_bin --plugin-load=cloud=ha_cloud.so --default-storage-engine=cloud --debug=d:t:i:L:F:o,/tmp/mysqld.trace
